    ...
    <div className="container-fluid d-flex flex-column align-items-center">
      <div className="post-generator my-3 post-card">
        <button
          ...
          type="button"
          onClick={() => dispatch(ACTIONS.logOut("zitaowww"))}
        >
          log Out
        </button>
      </div>
      ...
      <div className="login-component my-3">
        <div>
          <div className="mb-3">
            <label htmlFor="usernameInput1" className="form-label">
              Username
            </label>
            <input
              type="text"
          ...
          <div className="mb-3">
            <label htmlFor="passwordInput1" className="form-label">
              Password
            </label>
            <input
              type="password"
      ...
      <div className="post-generator my-3 post-card">
        <button
          className="btn btn-primary"
          type="button"
          onClick={() => dispatch(ACTIONS.deletePost("3LGR5hYGLm0EjhHwhmWz"))}
        >
      ...
      <div className="post-generator my-3 post-card">
        <button
          ...
          type="button"
          onClick={() =>
            dispatch(ACTIONS.modifyPost("loGt2WIpdHdXappX7mRh", a))
          }
        >
      ...
      <div className="post-generator my-3 post-card">
        <button
          className="btn btn-primary"
          type="button"
          onClick={() => dispatch(ACTIONS.getComments("CPoPrlvrO7nkNt3dQh8Y"))}
        >
          see comment
        </button>
      </div>
      ...
      <div className="post-generator my-3 post-card">
        <button
          ...
          type="button"
          onClick={() =>
            dispatch(ACTIONS.addComments("CPoPrlvrO7nkNt3dQh8Y", b))
          }
        >
          add comment
        </button>
      ...
      <div className="post-generator my-3 post-card">
        <button
          ...
          onClick={() =>
            dispatch(
              ACTIONS.modifyComment(
                "CPoPrlvrO7nkNt3dQh8Y",
                "2a7U3dnlv21fBqqgKxJE",
                b
              )
            )
          }
